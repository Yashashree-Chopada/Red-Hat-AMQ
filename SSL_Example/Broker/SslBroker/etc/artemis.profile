...
ARTEMIS_HOME='/home/ychopada/NotBackedUp/AMQ/amq-broker-7.8.2'
ARTEMIS_INSTANCE='/home/ychopada/NotBackedUp/AMQ/amq-broker-7.8.2/bin/SslBroker'
ARTEMIS_DATA_DIR='/home/ychopada/NotBackedUp/AMQ/amq-broker-7.8.2/bin/SslBroker/data'
ARTEMIS_OOME_DUMP='/home/ychopada/NotBackedUp/AMQ/amq-broker-7.8.2/bin/SslBroker/log/oom_dump.hprof'

# The logging config will need an URI
# this will be encoded in case you use spaces or special characters
# on your directory structure
ARTEMIS_INSTANCE_URI='file:/home/ychopada/NotBackedUp/AMQ/amq-broker-7.8.2/bin/SslBroker/'
ARTEMIS_INSTANCE_ETC_URI='file:/home/ychopada/NotBackedUp/AMQ/amq-broker-7.8.2/bin/SslBroker/etc/'
...
# Java Opts
if [ -z "$JAVA_ARGS" ]; then
    JAVA_ARGS=" -XX:+PrintClassHistogram -XX:+UseG1GC -Xms512M -Xmx2G -Dhawtio.disableProxy=true -Dhawtio.realm=activemq  -Dhawtio.offline=true -Dhawtio.role=amq -Dhawtio.rolePrincipalClasses=org.apache.activemq.artemis.spi.core.security.jaas.RolePrincipal -Djolokia.policyLocation=${ARTEMIS_INSTANCE_ETC_URI}jolokia-access.xml -Djon.id=amq"
fi
#
